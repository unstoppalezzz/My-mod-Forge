 ...
 */
@OnlyIn(Dist.CLIENT)
public class noddlessnakeman2entitymodel<T extends Entity> extends EntityModel<T> {
    ...
    public noddlessnakeman2entitymodel() {
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.field_178734_a, this.field_178733_c, this.field_178722_k, this.field_78116_c, this.field_178736_x, this.field_178732_b, this.field_178720_f, this.field_178723_h, this.field_78115_e, this.field_178724_i, this.field_178731_d, this.field_178721_j, this.field_178729_w, this.field_178730_v).forEach((modelRenderer) -> { 
