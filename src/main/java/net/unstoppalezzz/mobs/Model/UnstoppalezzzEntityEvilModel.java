...
public class UnstoppalezzzEntityEvilModel<T extends Entity> extends EntityModel<T> {
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.cape, this.LeftLeg, this.HeadInside, this.Body, this.Head, this.HoleBody, this.LeftArm, this.RightArm, this.RightLeg).forEach((modelRenderer) -> { 
